...
class TerminalApp:
    ...
    def show_about(self):
        about_text = (
            "ShellOS Version: Beta 1.3-Pre Build 241026\n"
            "Build Number: 241026\n"
            "Core Version: 1.0\n"
    ...
    def sysfetch(self):
        ...
        self.terminal.insert(tk.END, f"Version: Beta 1.3-Pre Build 241026\n")
        self.terminal.insert(tk.END, f"Build Number: 241026\n")
